...
const examTypes = [
  {
    ...
    body: (
      <>
        ...
        management-cadre roles — into Punjab&apos;s civil administration through competitive,
        merit-based examinations. These posts generally require a Bachelor&apos;s or Master&apos;s
        degree and involve an objective MCQ paper, sometimes followed by an additional written
        component, before the interview stage. Administrative posts can also lead toward related
        provincial civil service paths such as{" "}
        ...
        , conducted by FPSC rather than PPSC.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    body: "Beyond the categories above, PPSC periodically advertises other specialized posts — financial, scientific, IT, and administrative-specialist roles — each with eligibility and test pattern defined individually in the relevant advertisement.",
  },
];
...
const patternRows = [
  ...
  ["Technical (Engineer/Medical/Agriculture)", "Subject-specific technical paper", "Yes", "Written → Interview"],
];

const processSteps = [
  { title: "Advertisement", text: "PPSC publishes vacancy advertisements listing available posts, eligibility criteria, and application deadlines, typically through its official website and national newspapers." },
  { title: "Online Application", text: "Candidates apply through PPSC's official online application system within the advertised window, submitting required documents and information matching the post's eligibility criteria." },
  ...
  { title: "Roll Number Slip (Admission Certificate)", text: "Eligible candidates receive a roll number slip confirming their test center, date, and roll number, usually downloadable through PPSC's official portal closer to the exam date." },
  ...
  { title: "Result (Written Test)", text: "PPSC announces written test results, typically listing candidates who have qualified to proceed to the next stage." },
  { title: "Interview", text: "Shortlisted candidates attend an interview conducted by a PPSC panel, assessing subject knowledge, communication ability, and general suitability for the role." },
  ...
  { title: "Merit List", text: "Based on combined written test and interview results, PPSC prepares a final merit list ranking candidates according to available vacancies and quota allocation." },
...
const syllabusItems = [
  ...
  {
    title: "Punjab Affairs",
    text: "Covers Punjab-specific history, geography, administration, and notable regional facts — content that is less covered in general Pakistan Studies material but appears specifically in PPSC exams due to the commission's provincial scope. Preparation strategy: dedicate focused study time to Punjab-specific resources rather than assuming general current affairs preparation covers it adequately.",
  },
  {
  ...
  {
    title: "English",
    text: "Covers grammar, vocabulary, and comprehension relevant to objective-format PPSC papers. Preparation strategy: build grammar fundamentals through consistent MCQs practice, focusing on commonly tested rules rather than exhaustive academic grammar study.",
  },
  {
    title: "Urdu",
    text: "Covers grammar, vocabulary, and comprehension in Urdu, appearing in many general and assistant-level PPSC papers. Preparation strategy: practice objective-format Urdu MCQs alongside English, since both are often tested with similar question styles.",
  },
  {
  ...
  },
  {
    ...
    text: "Covers basic computer literacy, common software, and general IT awareness, appearing in many general and assistant-level papers. Preparation strategy: review fundamental computer concepts and commonly used office software, since questions are usually introductory rather than technical.",
  },
  {
    title: "Subject-Specific Content",
    text: "For lecturer, subject specialist, medical, engineering, law, and agriculture posts, subject-specific syllabus content follows the relevant academic or professional field. Preparation strategy: align study material directly with your degree-level knowledge in that subject, supplemented by past papers specific to that post category where available.",
  },
];
...
export default function PpscPillar() {
      ...
      <div className="bg-gradient-to-br from-[#0d47a1] via-[#1565C0] to-slate-900 px-4 md:px-6 py-12 md:py-16 text-white relative overflow-hidden rounded-b-[2rem]">
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <p className="text-blue-100/90 max-w-3xl text-sm md:text-base leading-relaxed mb-6">
            PPSC conducts recruitment for thousands of provincial government posts across Punjab every
            year — from administrative and clerical roles to lecturer, medical, engineering, and
            specialist positions. This guide brings together everything a candidate needs in one place:
            what PPSC actually tests, who&apos;s eligible for which post category, how the recruitment
          ...
          <div className="flex flex-wrap gap-3 mb-4">
            ...
            >
              Start Practicing PPSC MCQs <FaArrowRight size={11} />
            </Link>
            <Link
          ...
          <p className="text-sky-200/80 text-xs md:text-sm leading-relaxed max-w-3xl">
            ...
            eligibility, fees, and schedules against PPSC&apos;s official advertisements before applying.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-6 -mt-8 pb-16 space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-5 sm:p-8">
          <h2 className="text-xs font-black uppercase tracking-[0.15em] text-slate-400 mb-4">
            Start PPSC Preparation
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
            {[
              { name: "Practice PPSC MCQs", path: "/mcqs/ppsc" },
              { name: "PPSC Past Papers", path: "/past-papers/ppsc" },
              { name: "Online Tests", path: "/online-tests/ppsc" },
        ...
        <Section id="introduction" title="Introduction">
          <Prose>
            <p>
              The Punjab Public Service Commission (PPSC) is the primary recruiting body for{" "}
              <strong className="text-slate-900">Punjab government jobs</strong>, covering everything from
              entry-level clerical posts to senior specialist and management roles. For a large share of
              Pakistan&apos;s government job aspirants, PPSC represents the most frequent and accessible
              entry point into public sector employment, simply because of how many posts it advertises
              across the province each year.
            </p>
            <p>
              Thousands of candidates apply to PPSC recruitment cycles precisely because of this volume and
              variety — a single advertisement window can include administrative posts, teaching positions,
              medical officer roles, and technical specialist jobs all at once. But this same volume
              creates intense competition, and success depends heavily on how well a candidate matches their
              preparation to the specific post they&apos;re targeting rather than studying generically.
            </p>
            <p>
              Preparation strategy matters more with PPSC than many candidates initially realize. Because
              PPSC posts differ significantly in subject weightage, qualification requirements, and exam
              format, a candidate preparing for an administrative post needs a different study plan than one
              targeting a lecturer or engineering role. Skipping this distinction — and preparing from
              generic, unfocused material — is one of the most common reasons capable candidates
              underperform.
            </p>
            <p>
        ...
        <Section id="what-is-ppsc" title="What is PPSC?">
          <Prose>
            <p className="font-semibold text-slate-800">
              PPSC (Punjab Public Service Commission) is Punjab&apos;s constitutional body responsible for
              recruiting candidates into provincial government positions through competitive, merit-based
              examinations.
            </p>
            <p>
              <strong className="text-slate-900">History and constitutional basis:</strong> PPSC operates
              under Article 242 of the Constitution of Pakistan, which establishes public service
              commissions at the federal and provincial levels to ensure recruitment into government
              service is conducted on a merit basis rather than through informal or discretionary
              appointment.
            </p>
            <p>
              <strong className="text-slate-900">Mission:</strong> PPSC&apos;s core mandate is to conduct
              examinations and recruitment processes for provincial civil service posts in a transparent,
              competitive, and merit-based manner, ensuring that appointments to Punjab government
              departments are made according to candidates&apos; demonstrated ability rather than other
              factors.
            </p>
            <p>
              <strong className="text-slate-900">Responsibilities:</strong> PPSC&apos;s responsibilities
              include advertising vacant provincial posts, conducting written examinations and interviews,
              preparing merit lists, and recommending successful candidates to the relevant Punjab
              departments for appointment.
            </p>
            <p>
              <strong className="text-slate-900">Recruitment process at a glance:</strong> PPSC&apos;s
              process generally follows a consistent structure — public advertisement, online application,
              a written test (objective, subject-specific, or both depending on the post), and for most
              posts, a subsequent interview stage — before a final merit-based recommendation is sent to
              the hiring department. The full step-by-step breakdown is covered later in this guide.
            </p>
            <p>
              <strong className="text-slate-900">Departments PPSC recruits for:</strong> PPSC recruits
              across nearly every Punjab government department — School Education, Higher Education,
              Health, Agriculture, Irrigation, Communication &amp; Works, Revenue, Law, and general
              administration, among others — covering everything from entry-level assistant posts to
              senior specialist and administrative roles.
            </p>
            <p>
              <strong className="text-slate-900">Types of jobs recruited:</strong> The scope of PPSC
              recruitment spans administrative posts, assistant/clerical posts, lecturer and subject
              specialist posts, educators, medical officers, engineers, law officers, agriculture officers,
              and revenue department posts — each with its own eligibility criteria and test pattern,
            ...
            <p>
              ...
              , which recruits for federal government positions across the entire country, PPSC&apos;s
              jurisdiction is limited to provincial government posts within Punjab, which is part of why
              Punjab domicile is generally required for most PPSC posts.
            </p>
          </Prose>
        </Section>

        <Section id="types-of-ppsc-exams" title="Types of PPSC Exams">
          <Prose>
            <p>
              PPSC doesn&apos;t conduct a single, uniform exam — it manages recruitment across a wide
        ...
        <Section id="eligibility" title="PPSC Eligibility Criteria">
          <Prose>
            <p className="font-semibold text-slate-800">
              Eligibility for PPSC exams varies significantly depending on the specific post, but several
              factors apply broadly across most PPSC recruitment.
            </p>
            <p>
              <strong className="text-slate-900">Qualification:</strong> Requirements range from
              Intermediate for certain assistant-level posts to a Bachelor&apos;s degree for most general
              and administrative posts, a Master&apos;s degree for lecturer and certain specialist roles,
              and professional qualifications (MBBS, engineering degree, LLB) for medical, engineering, and
              legal posts respectively.
            </p>
            <p>
              ...
              specialist recruitment, with relaxation provisions for certain categories under Punjab
              government policy. Always confirm the exact age bracket and any relaxation provisions against
              the current advertisement, since these are periodically revised.
            </p>
            <p>
              <strong className="text-slate-900">Nationality:</strong> Candidates must generally be
              Pakistani citizens to be eligible for PPSC recruitment, as is standard for provincial
              government service.
            </p>
            <p>
              <strong className="text-slate-900">Experience:</strong> Entry-level posts typically require
              no prior experience, while mid-to-senior posts (particularly subject specialist, administrative,
              and technical roles) often require a specified number of years of relevant professional
              experience, detailed in the specific advertisement.
            </p>
            <p>
              <strong className="text-slate-900">Domicile:</strong> Most PPSC posts require Punjab
              domicile, since PPSC recruits specifically for provincial government positions within Punjab.
              Domicile and district-level quota requirements can vary by specific post, so candidates
              should verify the exact requirement against the official advertisement before applying.
            </p>
            <p>
              <strong className="text-slate-900">Quota:</strong> Punjab recruitment through PPSC operates
              under a quota system designed to ensure representation across districts and regions, alongside
              quotas for categories such as women, minorities, and disabled candidates, as defined by
              provincial policy. Quota structures can be revised, so candidates should verify current quota
              details for their specific post.
            </p>
            <p>
              <strong className="text-slate-900">Required Documents:</strong> Typically includes CNIC,
              educational certificates and transcripts, a Punjab domicile certificate, photographs, and any
              experience or professional registration relevant to the post — exact document requirements
          ...
          <p className="text-xs text-slate-500 leading-relaxed mt-3 bg-slate-50 border border-slate-100 rounded-xl p-3">
            Always verify exact qualification, age, and process requirements against the specific PPSC
            advertisement for your target post — this table reflects general patterns, not guaranteed
            current requirements.
          </p>
        </Section>

        <Section id="recruitment-process" title="PPSC Recruitment Process">
          <Prose>
            <p className="font-semibold text-slate-800">
              PPSC recruitment generally follows a consistent step-by-step structure, though specifics can
          ...
          <div
            ...
            role="img"
            aria-label="PPSC recruitment process timeline"
          >
          ...
          <p className="text-sm text-slate-600 leading-relaxed mt-5">
            ...
            high-volume recruitment drives, so candidates should plan their preparation timeline with this
            in mind.
          </p>
        </Section>

        <Section id="exam-pattern" title="PPSC Exam Pattern">
          <Prose>
            <p className="font-semibold text-slate-800">
              PPSC exam patterns differ depending on the post category, but generally fall into a few
              recognizable formats.
            </p>
            <p>
              <strong className="text-slate-900">MCQs (Objective Papers):</strong> Most assistant/clerical,
              administrative, and general posts use a single objective-type MCQ paper, typically covering
              general knowledge, Punjab Affairs, Pakistan Affairs, current affairs, and English/Urdu,
              usually within a defined negative-marking structure specified in the advertisement.
            </p>
            <p>
              <strong className="text-slate-900">Negative Marking:</strong> Negative marking policies can
              vary by specific PPSC test and are defined in the relevant advertisement or recruitment
              rules, so candidates should verify whether negative marking applies to their specific exam
              rather than assuming a single, uniform rule applies across all PPSC posts.
            </p>
            <p>
              <strong className="text-slate-900">Subject Weightage:</strong> For lecturer, subject
              specialist, medical, engineering, law, and agriculture posts, a dedicated subject-specific
              paper carries significant weightage alongside the general sections, testing specialized
              knowledge relevant to the role.
            </p>
            <p>
              <strong className="text-slate-900">Interview:</strong> Most PPSC posts include a panel
            ...
            <p>
              ...
              weightage defined per post category and detailed in the relevant recruitment rules.
            </p>
          </Prose>
        ...
        <Section id="syllabus" title="PPSC Syllabus Guide">
          <Prose>
            <p className="font-semibold text-slate-800">
              PPSC syllabus content varies by post, but several subjects appear consistently across most
              exam types.
            </p>
          </Prose>
        ...
        <Section id="preparation-strategy" title="Best PPSC Preparation Strategy">
          <Prose>
            <p className="font-semibold text-slate-800">
              A structured, time-bound preparation plan consistently outperforms unstructured studying.
              Here&apos;s a roadmap you can adapt to your own exam timeline for effective PPSC test
        ...
        <Section id="best-books" title="Best Books for PPSC">
          <Prose>
            <p>
              Rather than recommending specific titles (which can go out of print or be revised), here are
              the categories of preparation material worth prioritizing:
            </p>
          </Prose>
          <div className="mt-4">
            <BulletList
              items={[
                ...
                "Pakistan Affairs and Punjab Affairs guides aligned with the standard curriculum used in PPSC syllabi.",
                "Islamic Studies guides matching the standard curriculum used in PPSC and related competitive exams.",
                "English and Urdu grammar guides specifically designed for objective-format competitive exam preparation.",
                "Subject-specific reference material matching your degree background for lecturer, specialist, medical, engineering, law, or agriculture posts.",
        ...
        <Section id="past-papers" title="PPSC Past Papers">
          <Prose>
            <p>
              <strong className="text-slate-900">Why past papers matter:</strong> PPSC past papers reveal
              the actual phrasing, structure, and difficulty level used in real exams — information that
              generic study guides cannot fully replicate. They also help candidates recognize which
              topics PPSC tends to emphasize repeatedly across different recruitment cycles.
            </p>
            <p>
              <strong className="text-slate-900">How to analyze past papers:</strong> Rather than solving a
              past paper once and moving on, go through it topic by topic — identify which subjects
              appeared most frequently, note the specific phrasing style used, and treat every incorrect
              answer as a signal pointing to a genuine knowledge gap rather than just a wrong guess.
            </p>
            <p>
              <strong className="text-slate-900">Repeated topics:</strong> Certain general knowledge,
              Punjab Affairs, and current affairs topics tend to reappear across PPSC papers in different
            ...
            <p>
              ...
              treating past papers as casual reading material. This builds both content familiarity and
              exam-day pacing simultaneously.
            </p>
            <p>
              ...
              <Link href="/past-papers/ppsc" className="font-bold text-[#1565C0] hover:underline">
                PPSC past papers
              </Link>{" "}
        ...
        <Section id="mcqs" title="PPSC MCQs Preparation">
          <Prose>
            <p>
            ...
            <p>
              <strong className="text-slate-900">Punjab Affairs MCQs:</strong> Since Punjab Affairs is
              often under-covered in general preparation material, prioritize dedicated Punjab-specific
              MCQs alongside your general knowledge practice.
            </p>
            <p>
            ...
            <p>
              ...
              mirroring the actual PPSC paper format for your target post.
            </p>
            <p>
              <strong className="text-slate-900">Online practice:</strong> Practicing MCQs online allows
              for faster iteration and immediate feedback on incorrect answers compared to static printed
              material, making it a useful supplement to book-based study, particularly in the final weeks
              before your exam.
            </p>
          </Prose>
          <Link
          ...
          >
            Practice PPSC MCQs <FaArrowRight size={10} />
          </Link>
        </Section>

        <Section id="latest-jobs" title="Latest PPSC Jobs">
          <Prose>
            <p>
              <strong className="text-slate-900">Advertisements:</strong> PPSC publishes new job
              advertisements periodically throughout the year, covering administrative, teaching, technical,
              and specialized posts across Punjab government departments. Always review the full
            ...
            <p>
              ...
              processed, your roll number slip confirming your test center and date is issued closer to the
              exam, usually downloadable through PPSC&apos;s official portal.
            </p>
            <p>
              <strong className="text-slate-900">Test dates:</strong> Written test dates are announced
              following the application closing period; candidates should monitor official PPSC
            ...
            <p>
              ...
              for currently tracked openings, and always cross-verify against PPSC&apos;s official
        ...
        {/* FAQ */}
        <Section id="faq" title="Frequently Asked Questions About PPSC Exams">
                ...
                <div key={faq.q} className="border border-slate-100 rounded-xl overflow-hidden">
                  ...
                  {open && (
                    <div className="px-4 py-3 text-sm text-slate-600 leading-relaxed border-t border-slate-100 bg-white">
                      {faq.a}
                      {faq.q === "How is PPSC different from FPSC?" && (
                        <>
                          {" "}
                          Learn more on our{" "}
                          <Link href="/government-exams/fpsc" className="font-bold text-[#1565C0] hover:underline">
        ...
        <section className="bg-white rounded-2xl border border-slate-100 p-6 md:p-8 shadow-sm">
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            ...
            organized information about PPSC exams. Eligibility, fees, schedules, and syllabus details
            should always be verified against PPSC&apos;s official advertisements before applying, since
            these can be revised between recruitment cycles. If you notice outdated or incorrect
