...
const subjectsList = [
  ...
  },
  {
    ...
    desc: "Covers foundational teachings, history, and general religious knowledge when named in the syllabus. Prioritize accuracy over speed and review source material carefully.",
    link: "/category/islamic-studies",
    linkLabel: "Islamic Studies MCQs",
  },
  {
    name: "English",
    desc: "Grammar, vocabulary, and comprehension are the usual focus when English is listed in your syllabus. Build accuracy through regular MCQ practice rather than last-minute grammar rules.",
    link: "/category/english",
    linkLabel: "English MCQs",
  },
  {
    name: "Urdu",
    desc: "Language and comprehension are typically tested when Urdu appears in an advertisement's subject list. Match your practice to the paper format (objective or descriptive) your notice specifies.",
    link: "/category/urdu",
    linkLabel: "Urdu MCQs",
  },
  {
    name: "Everyday Science",
    desc: "Applied, general-awareness science topics rather than deep theory, when this area is listed in your syllabus. Focus on commonly tested daily-life science facts.",
    link: "/category/everyday-science",
    linkLabel: "Everyday Science MCQs",
  },
  {
    name: "Computer / IT",
    desc: "Most relevant for Computer Operator, IT, and similar technical posts where a computer-related paper or component is specified in the advertisement.",
    link: "/category/computer",
    linkLabel: "Computer MCQs",
  },
  {
    name: "Mathematics / quantitative",
    desc: "Basic to intermediate quantitative reasoning, appearing in some clerical, technical, or aptitude sections depending on the post.",
    link: "/category/math",
    linkLabel: "Maths MCQs",
  },
  {
    name: "Professional / subject paper",
    desc: "Degree-level or professional content for teaching, medical, engineering, and similar posts. Prepare from your academic background, aligned closely to the outline in your specific advertisement.",
    link: null,
  },
];
