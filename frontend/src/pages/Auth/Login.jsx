        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 font-sans antialiased">
            <div className="bg-white p-8 rounded-3xl border border-gray-100 w-full max-w-md shadow-2xl shadow-blue-100/50">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-1.5 ml-1">
                            ...
                            <Link to="/forgot-password" size="sm" className="text-[10px] text-blue-600 font-black uppercase tracking-wider hover:underline">Forgot?</Link>
                        </div>
                        <div className="relative group">
                ...
                <p className="text-center text-slate-500 text-sm font-medium">
                    New here? <Link to="/signup" className="text-blue-600 font-black hover:underline underline-offset-4">Create an account</Link>
                </p>
            </div>
        </div>
    );
