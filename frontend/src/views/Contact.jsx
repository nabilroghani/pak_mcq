            ...
            <div className="space-y-10 relative z-10">
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  ...
                  <a href={`tel:${siteConfig.phoneE164}`} className="text-lg font-bold hover:text-cyan-300">
              ...
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  ...
                  <a href={`mailto:${siteConfig.email}`} className="text-lg font-bold hover:text-cyan-300 break-all">
                    {siteConfig.email}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold">
                    {siteConfig.address.addressLocality}, {siteConfig.address.addressRegion}, Pakistan
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-20 relative z-10">
              ...
              <div className="flex gap-4">
                {[
                  ...
                  { icon: FaWhatsapp, link: siteConfig.whatsappChannel }
                ].map((social, index) => (
                  <a 
                    key={index} 
                    href={social.link} 
