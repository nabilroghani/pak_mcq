...
import { useRouter } from "next/navigation"; // useNavigate add kiya
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 font-sans antialiased">
            <div className="bg-white p-8 rounded-3xl border border-gray-100 w-full max-w-md shadow-2xl shadow-gray-200/50">
                ...
                {/* Back Button */}
                <Link href="/login" className="inline-flex items-center gap-2 text-blue-600 text-sm font-bold mb-8 hover:text-blue-700 transition-colors">
